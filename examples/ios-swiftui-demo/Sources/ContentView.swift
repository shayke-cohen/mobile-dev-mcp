...
struct HomeView: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 16) {
                        ...
                        QuickActionCard(icon: "cart", title: "Cart", color: .green) {
                            // Navigate to cart
                        }
            ...
            .navigationTitle("MCP Demo Store")
        }
    }
}
                ...
                HStack(spacing: 16) {
                    ...
                    Button {
                        ...
                        Text("Buy Now")
                            .frame(maxWidth: .infinity)
                            .padding()
                            .background(product.inStock ? Color.green : Color.gray)
                            .foregroundColor(.white)
                            .cornerRadius(12)
                    }
                    .disabled(!product.inStock)
    ...
    var body: some View {
        NavigationStack {
                    ...
                    List {
                        ...
                        Section {
                            Button {
                                ...
                                Text("Checkout ($\(appState.cartTotal, specifier: "%.2f"))")
                                    .frame(maxWidth: .infinity)
                                    .padding()
            ...
            .alert("Order Placed!", isPresented: $showingCheckoutAlert) {
                ...
                Text("Total: $\(appState.cartTotal, specifier: "%.2f")\nThank you for your order!")
            }
        }
    }
}
